...
public class EntityGenerationUtils {
    ...
    // static -> возмножность импортировать данный метод в другом классе без использования ЭТОГО класса
    ...
    public static List<PostEntity> generatePosts() {
        ...
        return Arrays.asList(post1, post2, post3); // вернём список постов
    }
}
